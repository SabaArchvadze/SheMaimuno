...
function GameApp() {
  ...
  // Update CSS var so monkeys know how far from the bottom of the screen they should sit
  useEffect(() => {
    document.documentElement.style.setProperty(
      '--monkey-base-bottom',
      isFullscreen ? '6px' : (useMobilePanel ? '52px' : '20px')
    );
  }, [isFullscreen, useMobilePanel]);
